...
class M_Detail_Diagnosa extends CI_Model
{
	...
	{
		$this->db->select("rekam_medis.*, diagnosa_idc_10.*, detail_diagnosa.keterangan_dg");
		$this->db->from("detail_diagnosa");
		$this->db->join("diagnosa_idc_10", "detail_diagnosa.kode_icd_10 = diagnosa_idc_10.kode_icd_10");
